...
\icode{queue.append("Name")} is used to add the person named \icode{Name}, because the names are stored as strings, and append because people go from the back to the front. \icode{queue.pop(0)} is used to remove and return the person at the front of the queue, at index 0.
\end{tcolorbox}
